...
internal inline fun SerialDescriptor.hashCodeImpl(typeParams: Array<SerialDescriptor>): Int {
    ...
    val namesHash = elementDescriptors.fold(1) { hash, element -> 31 * hash + element.serialName.hashCode() }
    val kindHash = elementDescriptors.fold(1) { hash, element -> 31 * hash + element.kind.hashCode() }
